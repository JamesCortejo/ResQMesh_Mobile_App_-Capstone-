...
import RescuerWelcomeCard from '../../components/RescuerWelcomeCard'; // 👈 NEW
import { meshNodes } from '../../data/meshNodes';
import { MeshNode } from '../../types/MeshNode';

const { width, height } = Dimensions.get('window');

const RescuerMapScreen = memo(() => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mapWrapper}>
              ...
              >
                <View style={styles.markerContainer}>
                  <Ionicons
                    name="location"
                    size={34}
                    color={node.distress ? '#d32f2f' : '#fb4f00'}
                  />
          ...
          <View style={styles.infoCard}>
            <Ionicons name="git-network-outline" size={18} color="#fb4f00" />
            <Text style={styles.infoText}>
              Rescuer view – mesh nodes & distress
            </Text>
          </View>
          ...
          {selectedNode && (
            <Animated.View style={[styles.bottomSheet, bottomSheetStyle]}>
              ...
              <Text style={styles.sheetText}>
                ...
                >
                  {selectedNode.distress ? 'DISTRESS' : 'Active'}
                </Text>
              </Text>
